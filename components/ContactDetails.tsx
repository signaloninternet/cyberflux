      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <a href="mailto:signalinternet@outlook.com" className="text-gray-300 hover:underline">
                meandwho@outlook.com
              </a>
            </div>
            <div>
              <h3 className="font-bold">Lead Backend Engineer</h3>
              <a href="mailto:satishbanchhere1@gmail.com" className="text-gray-300 hover:underline">
        ...
        <div>
          ...
          <div className="flex gap-6">
            <a href="#" className="text-white hover:text-[#00E0FF]">
              <GithubIcon size={24} />
            </a>
            <a href="#" className="text-white hover:text-[#00E0FF]">
