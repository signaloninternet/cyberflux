...
export default function ChangedCursor() {
  ...
  return (
    ...
    >
      <div
        className={`relative flex  bg-pink-600 items-center justify-center rounded-full transition-all duration-150 ease-out ${
          isHovering ? "w-16 h-16" : "w-8 h-8"
        }`}
      >
        <ArrowUpRight
          className={`transition-all duration-150 text-white m-4 ${
